...
class _AddPostWidgetState extends State<AddPostWidget> {
  ...
  void initState() {
    ...
    _model.postInfoTextController ??= TextEditingController();
    _model.postInfoFocusNode ??= FocusNode();
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: TextFormField(
                  controller: _model.postInfoTextController,
                  focusNode: _model.postInfoFocusNode,
                  autofocus: false,
                  obscureText: false,
                  ...
                  maxLines: 10,
                  minLines: 5,
                  validator: _model.postInfoTextControllerValidator
                      .asValidator(context),
                ),
              ),
              Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      FlutterFlowDropDown<String>(
                        controller: _model.postToValueController ??=
                            FormFieldController<String>(null),
                        options: ['Global', 'Classes', 'Club'],
                        onChanged: (val) =>
                            safeSetState(() => _model.postToValue = val),
                        width: 131.59,
                        height: 40.0,
                        textStyle:
                            FlutterFlowTheme.of(context).bodyMedium.override(
                    ...
                    onPressed: () async {
                      await PostsRecord.collection.doc().set({
                        ...createPostsRecordData(
                          postDescription: _model.postInfoTextController.text,
